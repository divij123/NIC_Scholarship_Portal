<%-- 
    Document   : createuser_district
    Created on : 4 Jun, 2019, 1:34:09 PM
    Author     : DIVIJ
--%>
...
<%
if(session.getAttribute("usertype").equals('5') || session.getAttribute("usertype").equals('7')){
...
%>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <br><br>
                    <h1 class="h2">Create District User</h1>
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="districtRegister" method="post">
